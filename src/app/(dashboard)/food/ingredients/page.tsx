...
export default function IngredientsPage() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    const payload = { name: form.name.trim(), unit_type: form.unit_type as Ingredient["unit_type"], default_unit: form.default_unit, unit_price: parseFloat(form.unit_price) || 0, inventory_group_id: form.inventory_group_id || undefined };
